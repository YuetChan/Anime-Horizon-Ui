...
export class PostApiService {
  ...
  createPost(postCreateDto : PostCreateDto){ return this.httpClient.post(this.domainURL + this.postURL, postCreateDto); }
  editPost(postEditDto : PostCreateDto){ return this.httpClient.patch(this.domainURL + this.postURL, postEditDto); }
